...
if minetest.settings:get_bool("modgen_generation") == false or
	core_game.modstorage:get_string("schematic") ~= "true" then
		minetest.log("info", "[PANQKART] Modgen generation is disabled or the schematics have been placed previously.")
		return
end
