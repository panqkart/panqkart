...
local about = {
	...
	S("Thanks to everyone else who has") .. " " .. S("contributed to this game. It's highly appreciated!") .. "\n",
    S("Any change in the rules will be announced in our") .. " " .. S("Discord server. Stay tuned for any new updates.") .. "\n",
	S("Like our game? Donate so we can keep doing more for") .. " " .. S("you and this game! https://github.com/sponsors/Panquesito7"),
	S("Join our Discord community to stay tuned about new updates, chat with our community,") .. " " .. S("share your maps, and much more.") .. "\n",
